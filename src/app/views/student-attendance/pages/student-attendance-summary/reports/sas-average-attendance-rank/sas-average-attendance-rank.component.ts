...
@Component({
  ...
  templateUrl: './sas-average-attendance-rank.component.html',
  styleUrls: ['./sas-average-attendance-rank.component.scss']
})
export class SasAverageAttendanceRankComponent implements OnInit {
  reportName: string = 'sas_average_attendance_rank';
  filters: any = [];
  levels: any;
  tableReportData: any;
