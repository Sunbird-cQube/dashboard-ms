...
@Component({
  selector: 'app-state-wise-progress-status',
  templateUrl: './state-wise-progress-status.component.html',
  styleUrls: ['./state-wise-progress-status.component.scss']
})
export class StateWiseProgressStatusComponent implements OnInit {
  reportName: string = 'state_wise_progress_status';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "State Wise Progress Status"
  };
  title: string = 'State Wise Progress Status'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
  ...
  constructor(private readonly _dataService: DataService,private csv:StateWiseProgressStatusTabComponent, private readonly _wrapperService: WrapperService, private _rbacService: RbacService) {
