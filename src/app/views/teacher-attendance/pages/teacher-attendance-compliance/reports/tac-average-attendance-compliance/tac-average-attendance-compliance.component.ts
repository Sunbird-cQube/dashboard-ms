...
@Component({
  ...
  templateUrl: './tac-average-attendance-compliance.component.html',
  styleUrls: ['./tac-average-attendance-compliance.component.scss']
})
export class TacAverageAttendanceComplianceComponent implements OnInit {
