...
@Component({
  selector: 'app-disanc-survey-map',
  templateUrl: './disanc-survey-map.component.html',
  styleUrls: ['./disanc-survey-map.component.scss']
})
export class DisancSurveyMapComponent implements OnInit {

  reportName: string = 'disanc_survey_map';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "disanc_survey_map"
  };
  title: string = 'disanc_survey_map'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;
